...
<script type="text/javascript">
	...
	$(function() {
		// 数据配置
		var cfg = {
			url : '${pageContext.request.contextPath}/users/getUserList.do',
			header : header,
	...
	function modify() {
		...
		if (selected.length > 0) {
			location.href = '${pageContext.request.contextPath}/users/editUser.do?operate=modify&id=' + selected[0].id;
		} else {
			alert('请选择一条数据!');
		}
	}
...
<body>
	...
	<div class="manage_bg">
		<input type="button" value="添加" class="btn70" onclick="location.href='${pageContext.request.contextPath}/users/editUser.do?operate=add';" /> 
